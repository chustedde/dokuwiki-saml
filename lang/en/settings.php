...
$lang['simplesaml_grps']        	= 'The SAML attribute that will be mapped to the Dokuwiki groups. Spaces in group names will be replaced with underscores. Example: roles';
